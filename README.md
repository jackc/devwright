...
SSH aliases generated by the previous Python orchestrator are recognized and
updated in place, so existing VMs do not need to be recreated for the Ruby port.
