# Historical multi-backend CLI

This describes the CLI before the project-recipe redesign. These commands are
not exposed by the current executable. See [README.md](README.md) for the current
Go launcher and native Lima workflow.
