...
//
//go:embed lima/dev-sandbox.json lima/bootstrap.sh lima/provision.sh lima/dotfiles.sh lima/credentials.sh incus/bootstrap.sh config/codex/*.toml guestbin/verify-linux-arm64.gz guestbin/verify-linux-amd64.gz
var recipe embed.FS
